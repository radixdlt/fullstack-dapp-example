interface Resources {
  ...
  "quests": {
    ...
    "QuestTogether": {
      ...
      "referralsSoFarDescription": "These friends have signed up using your link and completed the basic quests. You each get 30 XRD!",
      "alreadyClaimed": "Already claimed: {{amount}} XRD",
      "info_1": "<strong>Your friends will get 30 XRD</strong> when they use your referral link and complete all basic quests.",
      "info_2": "<strong>You’ll also receive 30 XRD</strong> for each referral and you’ll win <strong>extra rewards</strong> at each milestone (1, 5 and 10 referrals)!",
