interface Resources {
  ...
  "jetty": {
    ...
    "menu-text": "What can I do for you?",
    ...
    "cancel": "Cancel",
    "close": "Close",
    "connect-your-wallet": "Once you get your Full Stack Example Hero Badge, you’ll unlock these other options:",
    "elements": "Elements",
    ...
    "fuse-elements": {
      ...
      "more-than-max-elements": "It looks like you have {{count}} Element(s) in your registered Radix account. I can fuse up to 100 Elements at once.",
      "enough-elements": "Give me those Elements and I'll get started with fusing them into RadGems...",
      "send-button": "Send {{count}} Elements",
      "create-another": "Create More",
      ...
      "fusing-elements": "Fusing Elements...",
      "success": "Success!",
      "new-radgem": "Here’s your RadGem!",
      "new-radgems": "Here are your RadGems!",
      "quality": "Quality: {{quality}}/25",
      "radgem-claimed": "You can find your new RadGems with the NFTs in your registered Account in your Radix Wallet.",
    ...
    "create-radmorphs": {
      ...
      "title-card-selected": "Card selected!",
      "title-pick-2-gems": "Pick 2 RadGems",
      "title-pick-1-gem": "Pick 1 more RadGem",
      "title-gems-selected": "2 RadGems selected!",
      "title-review": "You have chosen...",
      "generate-preview": "Generate Preview",
      "card-quality": "Quality: {{quality}}/50",
      "limited-edition": "Limited Edition",
      "gem-quality": "Quality: {{quality}}/25",
      "radmorph-quality": "Quality: {{quality}}/100",
      "previewing-radmorph": "Previewing RadMorph...",
  ...
  "main": {
    ...
    "silverTickets": {
      ...
      "purchase-description": "Enter the quantity of referral links to purchase. Each link costs <b>50 XRD</b>, to be passed on to the user. It cannot be refunded.",
      "header": "Purchase Pre-funded Referral Links",
      "purchased-header": "Your Batches of Links",
      "purchased-at": "Purchased at",
      "expires-at": "Expires on",
      "set-info": "Set Expiration and Description",
      "claimed": "Claimed",
      "save": "Save",
      "enter-quantity": "Enter quantity",
      "purchase": "Purchase Links ({{amount}} XRD)",
      "purchase-empty": "Purchase Links",
      "quantity": "{{amount}} Referral Links",
      "download-csv": "Download CSV",
      "download-qr": "Download QR Codes",
      "not-logged-in": "To buy links, please login with a Persona that has gotten a Hero Badge on RadQuest."
    }
  },
  "quests": {
    "copy": "Copy",
    ...
    "JoinFriend": {
      "requirements": {
        "CompleteBasicQuests": "Complete the Basic Quests"
      },
      "title": "Join Your Friend",
      "description": "Accept your friend’s invitation!",
      "introDescription": "Once you’ve done the basic quests, accept your friend’s invitation and claim your reward"
    },
    "WhatIsRadix": {
      "requirements": {
        "RadixQuiz": "Learn about the Radix Network and dApps"
      },
    ...
    "TransferTokens": {
      "requirements": {
        "JettyReceivedClams": "Send some Clams to Jetty"
      },
