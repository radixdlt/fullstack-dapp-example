...
export const UpdateTransactionIntentStatus =
  (dbClient: PrismaClient, discriminator: string) =>
  (status: TransactionIntentStatus, error?: string) =>
...
export const UpdateTransactionIntentsStatus =
  (batchId: string, itemDiscriminators: string[], dbClient: PrismaClient) =>
