...
const getStringFieldValue = (data: ProgrammaticScryptoSborValue): string | undefined => {
  if (data.kind === 'String') return data.value
  return
}

const getDecimalFieldValue = (data: ProgrammaticScryptoSborValue): string | undefined => {
  if (data.kind === 'Decimal') return data.value
  return
}

const getReferenceFieldValue = (data: ProgrammaticScryptoSborValue): string | undefined => {
