...
CREATE TYPE "QuestStatus" AS ENUM(
    'IN_PROGRESS', 'READY_TO_CLAIM_REWARDS', 'COMPLETED'
);
...
-- AddForeignKey
ALTER TABLE "CompletedQuestRequirement"
ADD CONSTRAINT "CompletedQuestRequirement_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User" ("id") ON DELETE RESTRICT ON UPDATE CASCADE;